...
public class CulatorController {
    ...
    public String errorPage(){return calculator.error();}
    ...
    public Integer numbPlus(@RequestParam(value = "num1",required = false) Integer num01,@RequestParam(value = "num2",required = false)Integer num02){
         if (num01==null||num02==null){errorPage(); throw new RuntimeException();}
        else if (num01==null&&num02==null){errorPage(); throw new RuntimeException();}
